  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.backgroundSolid }]}>
      ...
      <LinearGradient
        ...
        style={[styles.inputContainer, { paddingBottom: insets.bottom > 0 ? insets.bottom : 10, borderTopColor: theme.border }]}
      >
        <View style={styles.anonymousOption}>
          <Text style={[styles.anonymousText, { color: theme.textPrimary }]}>Anonymous</Text>
          <Switch
            value={isAnonymous}
