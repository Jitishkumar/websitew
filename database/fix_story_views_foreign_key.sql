-- Fix story_views foreign key to reference profiles instead of auth.users
-- This will fix the PostgREST relationship error

-- Drop the existing foreign key constraint
ALTER TABLE public.story_views 
DROP CONSTRAINT IF EXISTS story_views_user_id_fkey;
